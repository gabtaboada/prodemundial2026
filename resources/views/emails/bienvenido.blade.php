...
<body>
	<p> 
		Bienvenido al prode de amigos Usa - Canada - Mexico :: 2026
	</p>
	<p> 
	...
	<p> 
		...
		Entonces será <strong>un punto </strong>por acertar <strong>Local</strong>, <strong>Empate </strong>o <strong>Visitante</strong> (como siempre) y <strong>un punto mas </strong>en caso de acertar el <strong>resultado exacto </strong>del partido.
	</p>	

	<p> 
		Les deseamos mucha suerte… y gracias por participar.
