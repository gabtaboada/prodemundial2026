            ...
            <div class="col-md-6 donail_right">
              ...
              -->
                                                ...
                                                <tbody>
                                                    <tr style="font-size:20px;">
                                                        <td>
                                                            <img src="{{ $UltimosResultados[0]->Bandera1 }}" alt=""
                                                                title=""
                                                    ...
                                                    <tr style="font-size:20px;">
                                                        <td>
                                                            <img src="{{ $UltimosResultados[0]->Bandera2 }}" alt=""
                                                                title=""
                                                                style="border-radius: 50%;border: 1px solid #ddd;"
                                                                width="40" height="40">
                                                        </td>
              ...
              -->
                                                ...
                                                <tbody>
                                                    <tr style="font-size:20px;">
                                                        <td>
                                                            <img src="{{ $UltimosResultados[1]->Bandera1 }}" alt=""
                                                                title=""
                                                                style="border-radius: 50%;border: 1px solid #ddd;"
                                                                width="40" height="40">
                                                        </td>
                                                    ...
                                                    <tr style="font-size:20px;">
                                                        <td>
                                                            <img src="{{ $UltimosResultados[1]->Bandera2 }}" alt=""
                                                                title=""
                                                                style="border-radius: 50%;border: 1px solid #ddd;"
                                                                width="40" height="40">
                                                        </td>
              ...
              -->
                                                ...
                                                <tbody>
                                                    <tr style="font-size:20px;">
                                                        <td>
                                                            <img src="{{ $UltimosResultados[2]->Bandera1 }}"
                                                                alt="" title=""
                                                                style="border-radius: 50%;border: 1px solid #ddd;"
                                                                width="40" height="40">
                                                        </td>
                                                    ...
                                                    <tr style="font-size:20px;">
                                                        <td>
                                                            <img src="{{ $UltimosResultados[2]->Bandera2 }}"
                                                                alt="" title=""
                                                                style="border-radius: 50%;border: 1px solid #ddd;"
                                                                width="40" height="40">
                                                        </td>
