...
<button type="button" id="confirmarActualizarApuesta" class="btn btn-primary">Confirmar</button>
<button type="button" id="cancelarApuesta" class="btn btn-danger">Cancelar</button>
