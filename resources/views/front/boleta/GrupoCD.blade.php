				...
				@foreach( $GrupoC as $partido)
					<tr style="border: 1px solid #ddd;">
						...
						<td>
							...
							<td>
								@if( $HabilitarCarga == 1)
									<button value="{{ $partido -> C_Partido }}/C" Onclick='ModificarApuesta(this);'  class='btn btn-link ' data-toggle='modal' data-target='#ModalEditarApuesta' style="padding:0px;"><img src="/FrontImages/edit.png" width="14" height="14" alt="Modificar Master" title="Modificar Master"></button>											
								@endif									
							</td>																			
					</tr>
				@endforeach
				...
				<table class="table">
					...
					<tr style="border: 1px solid #ddd;">
						...
						<td>
							...
							<td>
								@if( $HabilitarCarga == 1)
									<button value="{{ $partido -> D_Partido }}/D" Onclick='ModificarApuesta(this);'  class='btn btn-link ' data-toggle='modal' data-target='#ModalEditarApuesta' style="padding:0px;"><img src="/FrontImages/edit.png" width="14" height="14" alt="Modificar Master" title="Modificar Master"></button>											
								@endif									
							</td>																			
					</tr>
				@endforeach						
