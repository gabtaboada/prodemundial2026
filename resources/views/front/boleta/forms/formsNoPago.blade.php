<div class="pricing-grids-info">
		...
		<div class="FormuBoleta">
			<p style="text-align: left;line-height: 28px;width: 100%;margin: 30px 0 0;font-size: 18px;background-color:#9b0a13;padding-left:20px;">
				Para cargar la boleta tiene que realizar el pago
			</p>
