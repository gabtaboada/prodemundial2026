...
<div class="modal-footer">
    <button type="button" id="confirmarEstadoHabilitar" class="btn btn-primary">Confirmar</button>
    <button type="button" id="cancelarEstadoHabilitar" class="btn btn-danger">Cancelar</button>
</div>
            </div>
            <!-- /.modal-content -->
        </div>
