					...
					<tbody>
						@foreach( $GrupoE as $partido)
							<tr style="border: 1px solid #ddd;">
								...
								<td>
									@if( $HabilitarCarga == 1)
										<button value="{{ $partido -> E_Partido }}/E" Onclick='ModificarApuesta(this);'  class='btn btn-link ' data-toggle='modal' data-target='#ModalEditarApuesta' style="padding:0px;"><img src="/FrontImages/edit.png" width="14" height="14" alt="Modificar Master" title="Modificar Master"></button>											
									@endif									
								</td>																					
							</tr>
						@endforeach
				...
				<div class="tabla-cel-responsive">
					<table class="table">
						...
						<tr style="border: 1px solid #ddd;">
							...
							<td>
								@if( $HabilitarCarga == 1)
									<button value="{{ $partido -> F_Partido }}/F" Onclick='ModificarApuesta(this);'  class='btn btn-link ' data-toggle='modal' data-target='#ModalEditarApuesta' style="padding:0px;"><img src="/FrontImages/edit.png" width="14" height="14" alt="Modificar Master" title="Modificar Master"></button>											
								@endif									
							</td>																				
						</tr>
						@endforeach						
