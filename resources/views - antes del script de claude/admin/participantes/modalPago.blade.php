            ...
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <div class="modal-body">
                        ...
                        {!!Form::label('¿ Realizo el pago de la boleta ? :')!!}
                 ...
                 <div class="modal-footer">
                    {!!url('#',$title= 'Actualizar' ,$attributes = ['id'=>'confirmarActualizarPago','class'=> 'btn btn-primary'],$secure=null)!!}

                    {!!url('#',$title= 'Cancelar',$attributes = ['id'=>'cancelarActualizarPago','class'=> 'btn btn-danger'],$secure=null)!!}
