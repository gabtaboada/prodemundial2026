                            ...
                            <div class="table-responsive">
                                <table class="table">
									<div class="form-group">
										  	{!!Form::label('Filtros','Buscar participantes')!!}
									</div>
									{!! Form::model(Request::all(),['route'=>'admin.participantes.index','method' =>'GET','class'=>'navbar-form navbar-left pull-lef','role'=>'search'])!!}	
											<div class="form-group">
											  	{!! Form::text('ParticipanteBusqueda',null,['class'=>'form-control','placeholder'=>'Apellido / Nombre'])!!}
											   
											</div>
											<div class="form-group">
												{!!Form::select('pago', $pago,null,['class'=>'form-control','id'=>'pago'])!!}
											</div>											  
					   					      <div class="form-group">
                                    ...
                                    @foreach($participantes as $participante)
										<tbody>
										  <tr class="warning">	
											...
											<td>{!!link_to_route('admin.participantes.edit', $title = 'Editar', $parameters = $participante ->id, $attributes =['class'=>'btn btn-primary' ])!!}

											</td>
											<td>
												{!!Form::open(['route'=>['admin.participantes.destroy', $participante->id],'method'=>'DELETE'])!!}
