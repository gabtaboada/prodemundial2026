            ...
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <div class="modal-footer">
                    {!!url('#',$title= 'Eliminar' ,$attributes = ['id'=>'confirmarEliminarMaster','class'=> 'btn btn-primary'],$secure=null)!!}

                    {!!url('#',$title= 'Cancelar',$attributes = ['id'=>'cancelarEliminarMaster','class'=> 'btn btn-danger'],$secure=null)!!}
