            ...
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <div class="modal-footer">
                    {!!url('#',$title= 'Confirmar' ,$attributes = ['id'=>'confirmarActualizarAciertos','class'=> 'btn btn-primary'],$secure=null)!!}

                    {!!url('#',$title= 'Cancelar',$attributes = ['id'=>'cancelarActualizarAciertos','class'=> 'btn btn-danger'],$secure=null)!!}
