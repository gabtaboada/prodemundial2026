...
class IntocablesController extends Controller
{
    ...
    public function index()
    {
        ...
        $Posiciones = Participantes::select('aciertos.CantidadAciertos','aciertos.ac_Posicion','participantes.*')
                ...
                ->where('participantes.grupo_amigos_id','LIKE','%6%')// ID DREAM TEAM 5 
        ...
        return view('front.grupos.intocables',compact('Posiciones','Participantes'));
    }
